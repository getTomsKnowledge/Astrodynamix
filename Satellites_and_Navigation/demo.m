...
earlyColor = [0 0.4470 0.7410];
lateColor = [0.8500 0.3250 0.0980];
mixedColor = [0.9290 0.6940 0.1250];

figure('Name', 'Initial Orbit Determination');

% Pane 1: All orbits plotted simultaneously
subplot(3,4,[1:3, 1]);
plot3(beginningOrbit1(:,1), beginningOrbit1(:,2), beginningOrbit1(:,3), 'Color', earlyColor);
hold on;
plot3(beginningOrbit2(:,1), beginningOrbit2(:,2), beginningOrbit2(:,3), 'Color', earlyColor);
hold on;
plot3(beginningOrbit3(:,1), beginningOrbit3(:,2), beginningOrbit3(:,3), 'Color', earlyColor);
hold on;
plot3(endingOrbit1(:,1), endingOrbit1(:,2), endingOrbit1(:,3), 'Color', lateColor);
hold on;
plot3(endingOrbit2(:,1), endingOrbit2(:,2), endingOrbit2(:,3), 'Color', lateColor);
hold on;
plot3(endingOrbit3(:,1), endingOrbit3(:,2), endingOrbit3(:,3), 'Color', lateColor);
hold on;
plot3(orbit1FinalMixed(:,1), orbit1FinalMixed(:,2), orbit1FinalMixed(:,3), 'Color', mixedColor);
hold on;
plot3(orbit2FinalMixed(:,1), orbit2FinalMixed(:,2), orbit2FinalMixed(:,3), 'Color', mixedColor);
hold on;
plot3(orbit2FinalMixed(:,1), orbit2FinalMixed(:,2), orbit2FinalMixed(:,3), 'Color', mixedColor);

% Pane 2, Plot 1:  Early Dataset:
subplot(3,4,[1,2]);
plot3(beginningOrbit1(:,1), beginningOrbit1(:,2), beginningOrbit1(:,3), 'Color', 'r');
hold on;
plot3(beginningOrbit2(:,1), beginningOrbit2(:,2), beginningOrbit2(:,3), 'Color', 'g');
...
% Pane 2, Plot 3: Mixed-Time Dataset
subplot(3,4,[3,2]);
...
% Pane 3: Azimuth, Elevation errors
subplot(3,4,[1,3]);
...
subplot(3,4, [1,4]);
histogram(begRMSDistribution, 'Color', earlyColor);
subplot(3,4, [2,4]);
histogram(endRMSDistribution, 'Color', lateColor);
subplot(3,4, [3,4]);
histogram(mixedRMSDistribution, 'Color', mixedColor);
